        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className='flex items-center gap-2'>
                    <button onClick={() => handleDecrease(row.original.id)} className='p-1 rounded bg-gray-200 hover:bg-gray-300'>
                        <FaMinus size={12} />
                    </button>
                    <span>{row.original.quantity}</span>
                    <button onClick={() => handleIncrease(row.original.id)} className='p-1 rounded bg-gray-200 hover:bg-gray-300'>
                        <FaPlus size={12} />
                    </button>
                </div>
            ),
                ...
                <>
                    ...
                    <div className='mt-6 flex flex-col md:flex-row justify-between items-center gap-4'>
                        ...
                        <div className='text-right'>
                            <p className='text-xl font-semibold'>Total: <span className='text-[#25A8D6]'>৳{totalPrice}</span></p>
                            <Link to={'/checkout'}><Button label='Proceed to Checkout' /></Link>
                        </div>
                    </div>
                </>
            ) : (
